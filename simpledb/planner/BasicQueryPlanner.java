...
import simpledb.materialize.KMergeSortPlan;
...
public class BasicQueryPlanner implements QueryPlanner {
    ...
    public Plan createPlan(QueryData data, Transaction tx) {
        ...
        Collection<String> sorting = data.sorting();
        if (!sorting.isEmpty()) {
            // Step 5: Order the output by the specified sorting
            p = new KMergeSortPlan(p, sorting, tx);
        }
        return p;
    }
}
