...
public class BufferMgr {
    ...
    * @param numbuffers the number of buffer slots to allocate
    */
   public BufferMgr(int numbuffers, String bufferStrategy) {
       this.bufferMgr = (new BufferMgrFactory(bufferStrategy)).getBufferMgr();
       this.bufferMgr.init(numbuffers);
   }
   ...
   private boolean waitingTooLong(long starttime) {
    ...
    private class BufferMgrFactory {
        private String bufferStrategy;
        private static final String PACKAGE="simpledb.buffer.";
        private static final String CLASS = "BufferMgr";

        public BufferMgrFactory(String bufferStrategy) {
            this.bufferStrategy = bufferStrategy;
        }

        public AbstractBufferMgr getBufferMgr() {
            AbstractBufferMgr bufferMgr =  null;
            try {
                bufferMgr = (AbstractBufferMgr)
                        Class.forName(PACKAGE+bufferStrategy+CLASS)
                                .newInstance();
