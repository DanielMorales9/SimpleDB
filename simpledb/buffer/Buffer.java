    ...
    public class Buffer {
       ...
       public Buffer() {
            ...
            setLastPinTimestamp(Calendar.getInstance().getTimeInMillis());
       }
       ...
       public long getLastUnpinTimestamp() {
        ...
        public void setLastPinTimestamp(long lastPinTimestamp) {
            this.lastPinTimestamp = lastPinTimestamp;
        }

        public long getLastPinTimestamp() {
       ...
       public String toString() {
          String blk2String = "null";
          if (blk != null) {
             blk2String = blk.toString();
          }
          return "block: " + blk2String + " pins: "+pins;
       }
    }