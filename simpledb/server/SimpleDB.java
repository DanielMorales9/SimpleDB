...
public class SimpleDB {
     ...
     */
    public static void init(String dirname, String bufferReplacementStrategy) {
        initFileLogAndBufferMgr(dirname, bufferReplacementStrategy);
     ...
     * @param dirname the name of the database directory
     */
    public static void initFileLogAndBufferMgr(String dirname, String bufferReplacementStrategy) {
        initFileAndLogMgr(dirname);
        if (bufferReplacementStrategy != null) {
            bm = new BufferMgr(BUFFER_SIZE, bufferReplacementStrategy);
        }
        else {
