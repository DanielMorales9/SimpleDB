...
public class RecordFile {
    ...
    public int getInt(String fldname) {
        /* Is it necessary? -> */
        lastReadRecord = currentRid();
        if ( !this.statsRecord.containsKey(lastReadRecord) ) {
            this.statsRecord.put(lastReadRecord, new BasicRecordStats());
        }
        statsRecord.get(lastReadRecord).updateReadFieldsRecord();
    ...
    public void setInt(String fldname, int val) {
        /* Is it necessary? -> */
        lastWrittenRecord = currentRid();
        if ( !this.statsRecord.containsKey(lastWrittenRecord) ) {
            this.statsRecord.put(lastWrittenRecord, new BasicRecordStats());
        }
        this.statsRecord.get(lastWrittenRecord).updateWrittenFieldsRecord();
    ...
    public void delete() {
        ...
        this.statsRecord.get(lastWrittenRecord).updateWrittenRecord();
    }
    ...
    public void insert() {
        ...
        statsRecord.get(lastWrittenRecord).updateWrittenRecord();
    }
    ...
    private void moveTo(int b) {
        ...
        this.statsRecord.get(lastReadRecord).updateReadRecord();
    }
